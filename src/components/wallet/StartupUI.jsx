    ...
    return (
        <div className="content-wrapper">
            <div className="container-xxl flex-grow-1 container-p-y">
                <div className="row">
                    <h4 className="pb-1 mb-4">Start-up Savings Wallet</h4>
                        ...
                        <div className="card mb-4">
                            <div className="card-body">
                                ...
                                <p className="card-text">
                                    <i className='bx bxs-info-circle'></i> Wallet is <strong>LOCKED</strong> each cycle beginning.
                                </p>
                                <p className="card-text">
                                    <i className='bx bxs-info-circle'></i> <strong>AUTO</strong> deducts when funds reach amount for
